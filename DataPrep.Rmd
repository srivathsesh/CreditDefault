...
$\% VAR\ recovered = \frac{Predicted\ VAR}{Actual\ VAR}$
...
To get better model performance, data issues could be addressed. For example, in the data provided there were over 500 customers whose bill was 0, but were marked defaulting customer. Secondly additional features such as home ownership, credit score could be explored for prediciting defaulting customers. Additionally, different modeling approaches such as CHAID, SVM and different neural network architecture including Boltzmann Machines could be tried.  
