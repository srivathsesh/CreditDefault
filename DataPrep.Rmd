...
kable(Dict, align = "c",caption = "Data Dictionary") %>% 
...
creditdata %>% 
  ...
  group_by(data.group) %>% 
  summarise(datapoints = n()) %>% knitr::kable(caption = "Train,Validation and Test splits")
